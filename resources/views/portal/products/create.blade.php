                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form role="form"  class="form-transparent clearfix" enctype="multipart/form-data" method="POST" action="{{ route('products.store') }}">
                                ...
                                <div class="form-group">
                                    <label>Ảnh</label>
                                    <div id="drop-region" class="drop-region" onclick="document.getElementById('uploadImage').click()">
                                        <input class="image" name="image" id="uploadImage" type="file" style="display: none">
