                            ...
                            <form role="form" name="user-form" class="form-transparent clearfix" method="POST" action="{{ route('contacts.update', $contact->id) }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Tiêu đề</label>
                                            <input class="form-control" name="subject" disabled placeholder="Tiêu đề ....." value="{{ $contact->subject }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" placeholder="Nội dung ....." disabled class="form-control" rows="3">{{ $contact->content }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
